...
/////////////////
const BotName = 'NAMA BOTMU'; 'Mhmd Wildan';
const instagram = 'LINK INSTAGRAMU'; 'https://instagram.com/mhmdwildan';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@mhmdwildan)
})
